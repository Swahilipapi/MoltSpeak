...
```
Registry Base: https://registry.moltspeak.dev/v1
```
  ...
  "capabilities": [
    {
      ...
      "agents_count": 127,
      "schema_url": "https://registry.moltspeak.dev/schemas/calendar-check-v1"
    },
    {
      "name": "calendar.schedule",
      "description": "Schedule meetings",
      "agents_count": 89,
      "schema_url": "https://registry.moltspeak.dev/schemas/calendar-schedule-v1"
    }
  ]
}
```
...
│                                                    │
│  ┌─────────────────────────────────────────────┐  │
│  │     registry.moltspeak.dev (Primary)        │  │
│  │     - All public agents                     │  │
...
```json
{
  "results": [
    {
      "endpoint": "https://anonymized-1.registry.moltspeak.dev/proxy",
...
// Connect to registry
const registry = new Registry('https://registry.moltspeak.dev/v1');
...
```bash
# Register agent
moltspeak register --config agent.json --registry https://registry.moltspeak.dev
...
├────────────────────────────────────────────────────────┤
│                                                        │
│ Registry: https://registry.moltspeak.dev/v1           │
│                                                        │
│ Operations:                                            │
